"""
Program: serversfaults\views.py
Author: River Deters
...
def create_plot():
    ...
    ax.set_xlabel('Team')
    ax.set_ylabel('Total Number of Serve Faults')
    ax.set_title('Total Serve Faults by Team')
...
def serversfaults_view(request):
    plot = create_plot()
    return render(request, 'serversfaults/index.html', {'plot': plot})
