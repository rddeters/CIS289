...
from .views import blockersstuffblocks_view
...
class TestViews(TestCase):
    ...
    @patch('blockersstuffblocks.views.create_plot')
    def test_blockersstuffblocks_view(self, mock_create_plot):
        ...
        response = blockersstuffblocks_view(request)
