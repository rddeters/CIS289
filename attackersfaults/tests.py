...
from .views import attackersfaults_views
...
class TestViews(TestCase):
    ...
    @patch('attackersfaults.views.create_plot')
    def test_attackersfaults_views(self, mock_create_plot):
        ...
        response = attackersfaults_views(request)
