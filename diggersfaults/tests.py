...
from .views import diggersfaults_view
...
class TestViews(TestCase):
    ...
    @patch('diggersfaults.views.create_plot')
    def test_diggersfaults_view(self, mock_create_plot):
        ...
        response = diggersfaults_view(request)
