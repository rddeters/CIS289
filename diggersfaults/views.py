"""
Program: diggersfaults\views.py
Author: River Deters
...
def create_plot():
    ...
    ax.set_xlabel('Team')
    ax.set_ylabel('Number of Reception Faults')
    ax.set_title('Total Reception Faults by Team')
...
def diggersfaults_view(request):
    plot = create_plot()
    return render(request, 'diggersfaults/index.html', {'plot': plot})
