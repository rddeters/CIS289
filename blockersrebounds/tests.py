...
from .views import blockersrebounds_view
...
class TestViews(TestCase):
    ...
    @patch('blockersrebounds.views.create_plot')
    def test_blockersrebounds_view(self, mock_create_plot):
        ...
        response = blockersrebounds_view(request)
