...
from .views import receiversservereception_view
...
class TestViews(TestCase):
    ...
    @patch('receiversservereception.views.create_plot')
    def test_receiversservereception_view(self, mock_create_plot):
        ...
        response = receiversservereception_view(request)
