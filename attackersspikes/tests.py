...
from .views import attackersspikes_view
...
class TestViews(TestCase):
    ...
    @patch('attackersspikes.views.create_plot')
    def test_attackersspikes_view(self, mock_create_plot):
        ...
        response = attackersspikes_view(request)
